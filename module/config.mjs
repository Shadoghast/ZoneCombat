...
export const ZONE_COMBAT = {
  ...
  bands: [
    ...
    { key: "near",   label: "ZONECOMBAT.Band.Near",   maxFeet: 10,       weight: 3, color: 0x534ab7 },
    { key: "medium", label: "ZONECOMBAT.Band.Medium", maxFeet: 30,       weight: 3, color: 0x7f77dd },
    { key: "long",   label: "ZONECOMBAT.Band.Long",   maxFeet: 60,       weight: 1, color: 0xafa9ec },
    { key: "far",    label: "ZONECOMBAT.Band.Far",    maxFeet: Infinity, weight: 1, color: 0xcecbf6 }
  ],
